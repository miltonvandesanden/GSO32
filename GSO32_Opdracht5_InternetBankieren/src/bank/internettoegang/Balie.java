...
public class Balie extends UnicastRemoteObject implements IBalie, PropertyListener {
    ...
    public void PropertyChange(PropertyChangeEvent ev) {
        inform((IRekening) ev.getSource(), ev.getPropertyName(), ev.getOldValue(), ev.getNewValue());
    }
